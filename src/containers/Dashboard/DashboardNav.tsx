...
const DashboardNav = (props: DashboardNavProps) => {
  ...
  const languageOptions: SelectOptionType[] = [
    { value: 'vi', label: <span className="flex items-center"><img className="w-[20px] rounded-sm aspect-[4/3] me-2" src="/image/img_flag_vi.webp" alt="" />Tiếng Việt</span> },
    { value: 'en', label: <span className="flex items-center"><img className="w-[20px] rounded-sm aspect-[4/3] me-2" src="/image/img_flag_en.webp" alt="" />English</span> }
  ]
      ...
      <div className="flex justify-between items-center">
        ...
        <Dropdown menu={{ items: userMenu }}>
          <div className="ms-[32px] flex items-center cursor-pointer">
            ...
            <Text strong className="ms-1 text-lg">Test User</Text>
          </div>
        </Dropdown>
      </div>
    </div>
